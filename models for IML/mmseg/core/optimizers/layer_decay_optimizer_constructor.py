...
@OPTIMIZER_BUILDERS.register_module()
class LearningRateDecayOptimizerConstructorSLaK(DefaultOptimizerConstructor):
    """Different learning rates are set for different layers of backbone.
...
@OPTIMIZER_BUILDERS.register_module()
class LayerDecayOptimizerConstructorSLaK(LearningRateDecayOptimizerConstructorSLaK):
    """Different learning rates are set for different layers of backbone.
