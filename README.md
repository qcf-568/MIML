...
* <font size=10>We propose to harness constrained image manipulation models to automatically annotate the numerous unlabelled manually forged images from the web (e.g. those from [PhotoshopBattles](https://www.reddit.com/r/photoshopbattles/)). Thereby addressing the severe scarcity of non-synthetic data for image manipulation localization.</font>
